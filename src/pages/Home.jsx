  ...
  return (
    <>
      ...
      <div className="main-container">
        ...
        <p className="main-p">
          Depuis 2020, Canopées cultive bien plus que des jardins : nous façonnons des lieux de respiration,
          d'harmonie et de renouveau. Notre passion pour le vivant guide chacun de nos gestes, qu'il s'agisse
          de faire naître un paysage, de redonner vie à un arbre ou de simplement écouter ce que la nature nous murmure.
          <br /><br />
          Particuliers en quête de sérénité, entreprises soucieuses de leur environnement, ou communes
          désireuses d'embellir leur cadre de vie :
          <br />
          Nous vous aidons à réenchanter votre quotidien par la puissance végétale.
          <br /><br />
          Chez Canopées, nous croyons que la beauté naturelle est une œuvre d'équilibre, et que cet équilibre
          se cultive avec patience, respect et cœur.
        </p>
      </div>
      ...
      <div className="main-about-us">
        ...
        <p className="main-text-about-us">
          Complices depuis plus de 20 ans, Bob et Tom ont toujours partagé une passion commune pour les grands espaces,
          les arbres majestueux et le travail de la terre. En 2020, ils fondent Canopées avec un objectif clair :
          proposer des services paysagers durables, accessibles et humains. Leur amitié et leur complémentarité donnent
          à l'entreprise une âme que l'on retrouve dans chaque projet réalisé, du petit jardin intime au parc arboré.
        </p>
      ...
      <section>
        <div className="main-presta">
          ...
          <p className="presta-p">
            Canopées propose une gamme complète de services pour embellir, entretenir et valoriser vos espaces extérieurs,
            quels que soient leur taille ou leur usage. Que vous soyez un particulier souhaitant profiter d'un jardin harmonieux,
            une entreprise désireuse d'offrir un cadre verdoyant à ses collaborateurs, ou une collectivité attentive au bien-être
            de ses citoyens, notre équipe vous accompagne avec passion et professionnalisme. De la conception à la réalisation,
            de l'entretien régulier à des interventions ponctuelles comme la taille de haies, l'élagage ou le compostage,
            nous mettons tout en œuvre pour créer des espaces verts durables, esthétiques et respectueux de l'environnement.
          </p>
